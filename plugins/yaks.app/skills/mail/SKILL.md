---
name: mail
description: "Mail: an app's own address (yaks.app). Sending and receiving email from an app: the address a space and an app make, the rows that send a letter and who may ask for one, the delivered and bounced rows that come back, how an arrival lands with its attachments, and what the platform's mail does not do."
---
