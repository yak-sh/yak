---
name: code
description: "Code of your own (yaks.app). worker.js in front of an app's files: which routes are yours, what env holds (STORE, FILES, and the secrets you set), what the request reports about who is asking, the CPU and subrequest limits, and whole workers to copy."
---
