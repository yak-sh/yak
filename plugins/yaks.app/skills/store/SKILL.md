---
name: store
description: 'The store, from a page (yaks.app). ./api/client.js in full — apply, query, search, subscribe, upload and me — the shape of an entity bundle, patching and deleting, compare-and-set with $was so two writers cannot both spend one value, who may read and write, the byline on a row, seed.json for the data an app comes with, and the HTTP doors underneath.'
---
