...
Deno.test('session source: persisted identity projects a provider transcript through the public partition', () => {
  withSource((db) => {
    ...
    // Hold the graph_query boundary, not merely the lower-level entriesOf door.
