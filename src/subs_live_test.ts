...
slow(
  ...
  async () => {
    ...
    // One answer per stored edge (T-23824): the sentence is reported by its
    // VERB, beside the deps layer, and its own endpoint columns are held out of
    // the reference walk so nothing is counted twice.
