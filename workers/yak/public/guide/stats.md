...
guide:
  ...
  description: >-
    ...
    string — app_stats and the window it covers, the block on their space
    page, the endpoint a page reads its own numbers from, and why a small
    number is usually crawlers.
---
