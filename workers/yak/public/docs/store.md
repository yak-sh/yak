...
guide:
  ...
  description: >-
    ...
    — what a bundle of components looks like going in, patching and deleting,
    compare-and-set with $was so two writers cannot both spend one value, who
    may read and write, the byline on a row, seed.json for the data an app
    comes with, and the HTTP endpoints underneath.
---
