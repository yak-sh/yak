...
pub(crate) fn baked() -> Vocab {
    let comps = vec![
        ("doc".into(), vec![("title".into(), PropType::Text), ("body".into(), PropType::Body)]),
        (
            "task".into(),
            vec![
        ...
        ("project".into(), vec![("color".into(), PropType::Text)]),
        (
            "repo".into(),
            vec![
        ...
        (
            ...
            vec![
                ...
                (
                    "run_mode".into(),
                    PropType::Enum(vec!["long-loop".into(), "cold".into(), "cron".into()]),
                ),
        ...
        ("board".into(), vec![("query".into(), PropType::Query)]),
        ("layout".into(), vec![("root".into(), PropType::Eid("pane".into()))]),
        (
            "pane".into(),
            vec![
        ...
        ("canvas".into(), vec![]),
        ("web".into(), vec![("url".into(), PropType::Url)]),
        ("blob".into(), vec![("bytes".into(), PropType::Number)]),
        (
            "attachment".into(),
            vec![
        ...
        ("image".into(), vec![("w".into(), PropType::Number), ("h".into(), PropType::Number)]),
        (
            "card".into(),
            vec![
        ...
        ("shelf".into(), vec![("client".into(), PropType::Eid("client".into()))]),
        (
            "cursor".into(),
            vec![
                ("client".into(), PropType::Eid("client".into())),
        ...
        ("favorite".into(), vec![]),
        ("setting".into(), vec![("key".into(), PropType::Text), ("value".into(), PropType::Text)]),
        (
            "session".into(),
            vec![
        ...
        ("brief".into(), vec![("text".into(), PropType::Body)]),
        ("worktree".into(), vec![("cwd".into(), PropType::Text)]),
        (
            "runtime".into(),
            vec![
                ("pid".into(), PropType::Number),
        ...
        ("settled".into(), vec![]),
        ("yield".into(), vec![]),
        ("entry".into(), vec![("session".into(), PropType::Eid("session".into()))]),
        ("content".into(), vec![("body".into(), PropType::Body)]),
        (
            "message".into(),
            vec![("role".into(), PropType::Enum(vec!["user".into(), "agent".into()]))],
        ),
        ("prompt".into(), vec![]),
        ("attention".into(), vec![]),
        (
        ...
        ("call".into(), vec![("key".into(), PropType::Text)]),
        ("bash".into(), vec![("command".into(), PropType::Body), ("cwd".into(), PropType::Text)]),
        (
            "fetch".into(),
            vec![
                ("url".into(), PropType::Url),
        ...
        ("patch".into(), vec![("path".into(), PropType::Text), ("diff".into(), PropType::Body)]),
        ("tool".into(), vec![("name".into(), PropType::Text), ("detail".into(), PropType::Text)]),
        ("task_context".into(), vec![]),
        ("graph_query".into(), vec![("query".into(), PropType::Query)]),
        ("apply".into(), vec![("changes".into(), PropType::Body)]),
        ("result".into(), vec![("call".into(), PropType::Eid("call".into()))]),
        ("exit".into(), vec![("code".into(), PropType::Number)]),
        ("response".into(), vec![("status".into(), PropType::Number)]),
        ("headers".into(), vec![("data".into(), PropType::Body)]),
        ("stderr".into(), vec![("text".into(), PropType::Body)]),
        ("timeout".into(), vec![("ms".into(), PropType::Number)]),
        ("checkpoint".into(), vec![("through".into(), PropType::Eid("entry".into()))]),
        ("cancel".into(), vec![("target".into(), PropType::Eid("entity".into()))]),
        ("reasoning".into(), vec![]),
        ("recalled".into(), vec![("source".into(), PropType::Eid("entry".into()))]),
        ("opaque".into(), vec![("format".into(), PropType::Text), ("data".into(), PropType::Body)]),
        ("runner".into(), vec![("name".into(), PropType::Text)]),
        ("lease".into(), vec![]),
        ("usage".into(), vec![]),
        ("imported".into(), vec![]),
        (
        ...
        ("claim".into(), vec![("session".into(), PropType::Eid("session".into()))]),
        ("resume".into(), vec![]),
        (
            "subscription".into(),
            vec![
        ...
        ("stop_request".into(), vec![("target".into(), PropType::Eid("session".into()))]),
        ("fork".into(), vec![("from".into(), PropType::Eid("entry".into()))]),
        ("knock".into(), vec![("target".into(), PropType::Eid("entity".into()))]),
        (
            "wake".into(),
            vec![
        ...
        ("redaction".into(), vec![]),
        ("hook".into(), vec![]),
        ("comment".into(), vec![("target".into(), PropType::Eid("entity".into()))]),
        (
            "notice".into(),
            vec![
                ("target".into(), PropType::Eid("entity".into())),
        ...
        ("alias".into(), vec![("slug".into(), PropType::Text), ("slugs".into(), PropType::Text)]),
        ("person".into(), vec![]),
        ("persona".into(), vec![("home".into(), PropType::Eid("project".into()))]),
        (
            "model".into(),
            vec![
                ("name".into(), PropType::Text),
                ...
                (
                    "grade".into(),
                    PropType::Enum(vec!["frontier".into(), "mid".into(), "small".into()]),
                ),
            ],
        ),
        ("email".into(), vec![("address".into(), PropType::Text)]),
        ("memory".into(), vec![("scope".into(), PropType::Eid("project".into()))]),
        ("feedback".into(), vec![("by".into(), PropType::Eid("entity".into()))]),
        ("recall".into(), vec![]),
        ("created".into(), vec![("by".into(), PropType::Eid("entity".into()))]),
        ("updated".into(), vec![("by".into(), PropType::Eid("entity".into()))]),
        ("notified".into(), vec![]),
        ("opened".into(), vec![]),
        ("archived".into(), vec![]),
        ("quarantined".into(), vec![]),
        ("deliver".into(), vec![("to".into(), PropType::Eid("entity".into()))]),
        ("delivered".into(), vec![]),
        ("error".into(), vec![]),
        ("exception".into(), vec![]),
        (
        ...
        ("fixer".into(), vec![]),
        ("nofix".into(), vec![]),
        ("blocked".into(), vec![("on".into(), PropType::Text)]),
        (
            "completed".into(),
            vec![("at".into(), PropType::Time), ("by".into(), PropType::Eid("entity".into()))],
        ),
        (
            "cancelled".into(),
            vec![
    ...
    let stamped = HashMap::from([
        ("entity".into(), vec![("num".into(), PropType::Number)]),
        (
            "created".into(),
            vec![("at".into(), PropType::Time), ("via".into(), PropType::Eid("entity".into()))],
        ),
        (
            "updated".into(),
            vec![("at".into(), PropType::Time), ("via".into(), PropType::Eid("entity".into()))],
        ...
        ("favorite".into(), vec![("at".into(), PropType::Time)]),
        ("decided".into(), vec![("via".into(), PropType::Eid("entity".into()))]),
        ("proposed".into(), vec![("via".into(), PropType::Eid("entity".into()))]),
        ("web".into(), vec![("frozen_at".into(), PropType::Time)]),
        ("client".into(), vec![("ip".into(), PropType::Text)]),
        ("claim".into(), vec![("claimed_at".into(), PropType::Time)]),
        (
            "resume".into(),
            vec![
                ("actor".into(), PropType::Eid("entity".into())),
        ...
        ("delivered".into(), vec![("at".into(), PropType::Time), ("via".into(), PropType::Text)]),
        ("error".into(), vec![("at".into(), PropType::Time), ("message".into(), PropType::Text)]),
        (
            "exception".into(),
            vec![
                ("at".into(), PropType::Time),
        ...
        ("blocked".into(), vec![("since".into(), PropType::Time)]),
        (
            "mail".into(),
            vec![
        ...
        ("memory".into(), vec![("last_confirmed_at".into(), PropType::Time)]),
        (
            "recall".into(),
            vec![
        ...
        (
            "worktree".into(),
            vec![("branch".into(), PropType::Text), ("base_revision".into(), PropType::Text)],
        ),
        (
            "runtime".into(),
            vec![
        ...
        (
            ...
            vec![
                (
                    "status".into(),
                    PropType::Enum(vec!["starting".into(), "running".into(), "stopping".into()]),
                ),
                ("started_at".into(), PropType::Time),
                ("stop_requested_at".into(), PropType::Time),
                ("input_at".into(), PropType::Time),
        ...
        ("entry".into(), vec![("seq".into(), PropType::Number)]),
        ("generation".into(), vec![("serving_model".into(), PropType::Text)]),
        (
            "imported".into(),
            vec![("source".into(), PropType::Text), ("line".into(), PropType::Number)],
        ),
        (
            "lease".into(),
            vec![
        ...
        ("completed".into(), vec![("via".into(), PropType::Eid("entity".into()))]),
        ("cancelled".into(), vec![("via".into(), PropType::Eid("entity".into()))]),
    ]);
