 ...
 * install — so this package keeps them in a Map, evaluates queries with
 * {@link https://jsr.io/@yaks/match | @yaks/match}, and implements the same
 * five members every other adapter does. The same `apply()`, the same query
