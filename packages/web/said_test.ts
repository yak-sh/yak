...
Deno.test('saidLines: everything the owner authored, oldest first', () => {
  ...
  assertEquals(saidLines(all, byEid, 10), [
    '- 09-01 19:25 #e1 turn S-1 · first thing',
    '- 09-01 19:26 #c1 comment T-2 · ship it',
    ...
    '- 09-01 19:40 #e2 turn S-1 · second thing',
  ])
  ...
  assertEquals(saidLines(all, byEid, 1, 39), [
    '- 09-01 19:40 #e2 turn S-1 · second thi…',
  ])
